...
GRAPHITE_HOST = 'graphite.lab1.fanops.net'

# The Graph url used to link to Graphite (Or another graphite dashboard)
# %s will be replaced by the metric name
GRAPH_URL = 'http://graphite-lab1.fanops.net/render/?width=1400&from=-1hour&target=%s'
...
ALERTS = (
    ("skyline", "smtp", 1800),
    ("ganglia", "smtp", 1800),
    ("skyline", "hipchat", 18000),
    ("ganglia", "hipchat", 18000),
)
...
SMTP_OPTS = {
    ...
    "recipients": {
        "skyline": ["ckhajavi@rubiconproject.com", "ksanthanam@rubiconproject.com"],
    },
}

# HipChat alerts require python-simple-hipchat
HIPCHAT_OPTS = {
    "auth_token": "vTWoB0Rj40EmNrJT9XPcgNiF14KIcV8AGz2UwDGz",
